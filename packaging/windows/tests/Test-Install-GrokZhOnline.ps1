...
function New-TestRelease {
    ...
    $assets = foreach ($name in $names) {
        ...
        [pscustomobject]@{ name = $name; state = 'uploaded'; size = [long]$body.Length
            ...
            browser_download_url = "https://github.com/Catapult291/GrokZen/releases/download/$tag/$name" }
    }
...
'@, $utf8)
    ...
    $contract = Get-OnlineReleaseContract $release
    $api = 'https://api.github.com/repos/Catapult291/GrokZen/releases?per_page=100&page=1'
