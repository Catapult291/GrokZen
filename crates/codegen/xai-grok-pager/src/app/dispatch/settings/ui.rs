...
use super::setters::{
    ...
    set_default_selected_permission_inner, set_default_shell_inner,
...
pub(in crate::app::dispatch) fn action_for_reset(
    ...
    match (key, value) {
        ...
        ("default_shell", SettingValue::Enum(s)) => Some(Action::SetDefaultShell((*s).to_string())),
...
pub(in crate::app::dispatch) fn apply_setting_rollback(
    ...
    match (key, rollback_value) {
        ...
        ("default_shell", SettingValue::Enum(s)) => {
            set_default_shell_inner(app, crate::settings::canonical_default_shell(Some(s)));
        }
