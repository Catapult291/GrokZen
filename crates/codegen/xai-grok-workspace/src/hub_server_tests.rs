...
async fn delete_scheduled_task_rpc_reports_honestly() {
    ...
    local
        .run_until(async {
            ...
            let snap: TasksSnapshotResponse =
                serde_json::from_value(snap_value).expect("decode snapshot");
            assert_eq!(
...
async fn dispatch_knows_every_typed_method() {
    ...
    local
        .run_until(async {
            ...
            use crate::worktree::{
                ApplyWorktreeRequest, CreateWorktreeRequest, RemoveWorktreeRequest,
            };
            ...
            use xai_grok_workspace_types::rpc::workspace::{
                ConfigureMcpReq, DropSessionReq, InstallPluginReq, LoadEnvrcReq,
                LoadPermissionsReq, LoadProjectConfigReq, RefreshPluginsReq,
                ResolveFileReferencesReq, ToolDefinitionsReq, UpdateToolConfigReq,
            };
...
async fn presence_note_stamps_only_visible_notes_for_live_sessions() {
    ...
    local
        .run_until(async {
            ...
            use xai_tool_protocol::IdleWithholdReason;
            let handle =
                crate::handle::tests::make_handle_with_status_config(crate::StatusConfig {
