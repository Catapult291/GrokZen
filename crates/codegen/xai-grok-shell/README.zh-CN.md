...
> 完整中文用户指南见 [GitHub 在线文档](https://github.com/Catapult291/grok-zh/blob/zh-dev/crates/codegen/xai-grok-pager/docs/user-guide/zh-CN/README.md)；可下载版本见 [Releases](https://github.com/Catapult291/grok-zh/releases)。
