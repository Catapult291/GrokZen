...
mod tests {
    ...
    fn community_api_urls_follow_the_product_repository_identity() {
        assert_eq!(release_repo(), "Catapult291/GrokZen");
        assert_eq!(
            releases_api(2),
            "https://api.github.com/repos/Catapult291/GrokZen/releases?per_page=100&page=2"
        );
        assert_eq!(
            release_by_tag_api("1.0.3").unwrap(),
            "https://api.github.com/repos/Catapult291/GrokZen/releases/tags/v1.0.3"
        );
        assert_eq!(
            release_by_tag_api("1.0.9").unwrap(),
            "https://api.github.com/repos/Catapult291/GrokZen/releases/tags/release-v1.0.9"
        );
    }
